    ...
    $(document).ready(function () {
        ...
        $("#ticketForm").submit(function () {
            ...
            if ($(":input").hasClass("needsfilled")) {
                ...
                errornotice.hide();
								var ticketnumber = GetTicket(country.val(), firstname.val(), lastname.val(), email.val(), phone.val(), product.val(), description.val(), accountnumber.val(), company.val(), "German", postcode.val(), "");
