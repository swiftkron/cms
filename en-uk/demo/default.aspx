...
<input type=hidden name="DialogID" value="235">
...
<div id="formElementX" class="formRow"><span id="reqOptIn"><input  id="check1" type="checkbox" checked="check" onchange="setValues();" />  Yes! Please send emails regarding Act!</span></div>

<div id="formElement9" >
	<input type="submit" value="Send" class="btn btn-primary" onClick="ga('send', 'event', 'UK Demo', 'demonstration-request', 'send');"/>
</div>
...
<!-- end FORM -->
    ...
    <div class="container">
        <div class="row">
            ...
            <img src="/en-uk/img/limefresh.jpg" /> <img src="/en-uk/img/mcj.jpg" /> <img src="/en-uk/img/corkers.jpg" />
            </div>
        </div>
    </div>
