...
<asp:Content ID="MetaContent" ContentPlaceHolderID="HeadContent" runat="server">
	<title>Act! on Values: Productivity Video | Accomplish more</title>
...
<asp:Content ID="StyleContent" ContentPlaceHolderID="StyleContent" runat="server">
    ...
    <style type="text/css">
		...
		.heroFormInner{padding-top:90px;}
		}
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="hero">
            ...
            <div class="heroText">
                ...
                <p>We&rsquo;ve all been there; keeping control over all your tasks can be daunting. Watch this video to see how Act! can help you maximize your productivity and work smarter to accomplish more. </p>
                <a href="https://www.youtube.com/watch?v=niUjV0EHqXk" target="_blank"><button type="button"><span class="halflings glyphicon-play"></span> <span class="btnText">Watch the Video</span></button></a>
              </div>
            </div>
            <!-- form -->
            <div class="heroForm">
        ...
        <div class="colWrap">
            ...
            <p>See what&rsquo;s new in the Act! blog, and join the conversation on Twitter and the <span class="nobr">Act! Community.</span></p>
