...
<asp:Content ID="MetaContent" ContentPlaceHolderID="HeadContent" runat="server">
	<title>Act! | Business Care is Ending</title>
...
<asp:Content ID="StyleContent" ContentPlaceHolderID="StyleContent" runat="server">
    ...
    <style type="text/css">
		...
		.hero{background:#EFF1F3;color:#65727A;}
		...
		.disclaimer p{font-size:12px;line-height:14px;text-align:left;}
		.heroForm .disclaimer p{color:#EFF1F3;}
		@media(min-width:768px){
		.hero h1{font-size:44px;}
		.hero h2{font-size:30px;}
		.hero h3{font-size:24px;}
		.heroForm{min-height:1050px}
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["bcrenewpro"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="hero">
            ...
            <div class="heroText">
                ...
                <h2>But we've got you covered with these great options.  Call us at <strong class="orange nobr">866-738-7707</strong>.</h2>
                <h3>Option 1: Subscribe to Act! Premium &ndash; <em>recommended</em>.</h3>
                <p>Here's what you get:</p>
                <ul>
                  <li>Free upgrade to Act! Premium, with team features, Mobile&sup1;, and enhanced administration and security</li>
                  <li>Automatic feature enhancement and platform updates, so you always have the latest and greatest</li>
                  <li>Expert technical support through live chat, toll-free phone, and email</li>
                ...
                <h3>Option 2: Subscribe to 30-Day support for <span class="nobr">Act! Pro</span></h3>
                <p>Should you choose to remain on your current version of Act! Pro, you can add 30-Day technical support at any time.</p>
                <p>Call us to purchase now <strong class="orange">866-738-7707</strong></p>
              </div>
            </div>
            <!-- form -->
            <div class="heroForm">
              <div class="heroFormInner">
                <h2>Over 20% discount<span class="sup">&sup2;</span> for a limited time<span class="sup">&sup3;</span> only</h2>
                <h3>Sign up now</h3>
                <form method="GET" action="https://s1966950654.t.eloqua.com/e/f2">
                	<input name="LeadSource" type="hidden" value="LCRMAA0001WJ" />
                	<input name="elqFormName" type="hidden" value="bcrenewpro" />
...
<div class="footnotes">
	<div class="footnotesInner">
  	<p>&sup1; Act! Premium Mobile requires setup and configuration of Act! Premium (access via Web). Data access available via active Internet connection from supported device browsers. Review Act! system requirements at <a href="http://act.com/systreq" target="_blank">act.com/systreq</a>. You are responsible for all data-related charges.</p>
  	<p>&sup2; Offer only valid in the US. Discount off of MSRP. Cannot be combined with other offers.</p>
  	<p>&sup3; Exclusive offer available to current Business Care Customers for up to 30 days after Your Business Care renewal date.</p>
  </div>
</div>
</asp:Content>
