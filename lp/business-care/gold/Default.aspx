...
<asp:Content ID="MetaContent" ContentPlaceHolderID="HeadContent" runat="server">
	<title>Act! | Business Care Gold is Ending</title>
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["bcrenewgold"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
...
<script src="/js/elq/bcrenewal.js" type="text/javascript"></script>
</asp:Content>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="hero">
            ...
            <div class="heroForm">
              <div class="heroFormInner">
                <h2>Over 20% loyalty discount<span class="sup">&sup1;</span> for a limited time<span class="sup">&sup2;</span> only</h2>
                <h3>Renew now</h3>
                <form method="GET" action="https://s1966950654.t.eloqua.com/e/f2">
                	<input name="LeadSource" type="hidden" value="LCRMAA0001WG" />
                	<input name="elqFormName" type="hidden" value="bcrenewgold" />
                	<input name="elqSiteID" type="hidden" value="1966950654" />
                	<input name="elqCustomerGUID" type="hidden" value="" />
                	<input name="elqCookieWrite" type="hidden" value="0" />
                	<input name="SLXAccountID" type="hidden" value="" />
                	<input name="SLXContactID" type="hidden" value="" />
                	<input name="SLXLeadID" type="hidden" value="" />
        ...
        <div class="cta">
        	<div class="ctaInner">
            <h4>Get even more with Premier Support for just $5 more</h4>
            <p><strong>Premier Support includes all of the great benefits listed above, plus:</strong></p>
            <ul>
            	<li>High priority queue</li>
              <li>Voicemail call-back</li>
              <li>Appointment setting</li>
              <li>Voice mail call back</li>
              <li>24x6 coming soon!</li>
            </ul>
            <h4>Call us to purchase now <strong class="nobr">866-738-7707</strong></h4>
          </div>
        </div>
        <!-- .end cta -->
...
<div class="footnotes">
	<div class="footnotesInner">
  	<p>&sup1; Offer only valid in the US. Discount off of MSRP. Cannot be combined with other offers.</p>
  	<p>&sup2; Exclusive offer available to current Business Care Customers for up to 30 days after Your Business Care renewal date.</p>
  </div>
</div>
</asp:Content>
