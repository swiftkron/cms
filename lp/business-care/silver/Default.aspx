...
<asp:Content ID="MetaContent" ContentPlaceHolderID="HeadContent" runat="server">
	<title>Act! | Business Care Silver is Ending</title>
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["bcrenewsilver"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
            ...
            <div class="heroForm">
              <div class="heroFormInner">
                ...
                <form method="GET" action="https://s1966950654.t.eloqua.com/e/f2">
                	<input name="LeadSource" type="hidden" value="LCRMAA0001WH" />
                	<input name="elqFormName" type="hidden" value="bcrenewsilver" />
