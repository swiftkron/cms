...
<input type=hidden name="DialogID" value="290">
<input type="hidden" id="LeadSource" name="LeadSource" value="SPINTL Act! Request a Demonstration">
<input type=hidden name="rurl" value="http://www.act.com/fr-fr/demo/default.aspx?thankyou">
...
<div id="formElementX" class="formRow"><span id="reqOptIn"><input  id="check1" type="checkbox" checked="check" onchange="setValues();" />Oui, merci de m’envoyer des emails concernant Act!</span></div>

<div id="formElement9" >
	<input type="submit" value="Envoyer" class="btn btn-primary" onClick="ga('send', 'event', 'FR Demo', 'demonstration-request', 'send');"/>
</div>
