...
<input type="hidden" id="LeadSource" name="LeadSource" value="SPINTL Act French contact me form">
<input type=hidden name="rurl" value="http://www.act.com/fr-fr/contact/default.aspx?thankyou">
...
<div id="formElementX" class="formRow">
	<span id="reqOptIn">
		<input id="check1" type="checkbox" checked="check" onchange="setValues();" />  Oui, merci de m’envoyer des emails concernant Act!
	</span>
</div>

<div id="formElement9"><input  class="btn btn-primary" type="submit" value="Envoyer" onClick='ga('send', 'event', 'FR Contact', 'send-message', 'send-message');'/></div>
