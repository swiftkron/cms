...
<body id="trial_page">
            ...
            <div class="col-sm-6 contact-form tablecell">
              <div class="col-md-10 col-md-push-2">
                ...
                <form action="https://www.msgapp.com/RESTForm.aspx" method="GET">
                  ...
                  <input type=hidden name="DialogID" value="85">
                  <input type="hidden" id="LeadSource" name="LeadSource" value="SPINTL Act French trial form">
                  <input type=hidden name="rurl" value="http://www.act.com/fr-fr/essai/default.aspx?thankyou">
                  <input type=hidden name="DoNotSolicit" id="DoNotSolicit" value="0">
                  <input type=hidden name="TriggerID" id="TriggerID" value="1638">
                  <input type=hidden name="opIn" id="opIn" value="Y">

                  <div id="formElement0"  class="formRow">
                    <label for="Prefix">Titre*</label>
                  ...
                  <input type="submit" class="btn btn-primary" value="Télécharger la démo" onClick="ga('send', 'event', 'FR Trial', 'form-complete', 'trial-download');" />
        ...
        <script type="text/javascript" >var FirstName = new LiveValidation("FirstName", {valid: "", onlyOnBlur: true});FirstName.add(Validate.Presence, {failureMessage:"Ce champ est obligatoire"});var LastName = new LiveValidation("LastName", {valid: "", onlyOnBlur: true});LastName.add(Validate.Presence, {failureMessage:"Ce champ est obligatoire"});var Company = new LiveValidation("Company", {valid: "", onlyOnBlur: true});Company.add(Validate.Presence, {failureMessage:"Ce champ est obligatoire"});var WorkPhone = new LiveValidation("WorkPhone", {valid: "", onlyOnBlur: true});WorkPhone.add(Validate.Presence, {failureMessage:"Ce champ est obligatoire"});var MailingCountry = new LiveValidation("MailingCountry", {valid: "", onlyOnBlur: true});var Email = new LiveValidation("Email", {validNotes: "", onlyOnBlur: true});Email.add(Validate.Presence, {failureMessage:"Ce champ est obligatoire"});Email.add(Validate.Format, {pattern: /^[ ]*([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})[ ]*$/i, failureMessage: "Une adresse email valide est requise"});
          ...
          var thankYouMessage = "<p><strong class='orangetitle'>Télécharger votre version d'Act! Pro GRATUITE 30 jours</strong></p><p><a href='http://cdn.act.dlm.swiftpage.com/3713/actpro_v163x13_fr.exe' class='btn-second btn' onClick='ga('send', 'event', 'FR Trial', 'pop-up', 'Telecharger');'>Télécharger</a></p><p>Nous contacter :</p><p>France : 09 75 18 23 09<br />Service commercial : <a href='mailto:vente@swiftpage.com' onClick='ga('send', 'event', 'FR Trial', 'pop-up', 'vente@swiftpage.com');'>vente@swiftpage.com</a><br /></p><p><a href='produits/systeme'>Configurations système</a></p>";
