...
<style type="text/css">
.heroBanner{
	background:#2A353D url('/img/hero-wine-corks.jpg') top left no-repeat;
...
<div class="hero">
  ...
  <div class="heroBanner">
  	<div class="heroBannerInner">
    	...
    	<p>After more than 25 years, Act! is <strong>still</strong> the #1 best-selling contact and customer manager. Like a fine wine, it’s getting better with age. Now, more than ever, the Act! suite of solutions works the way you work — with ultimate flexibility to meet all your payment, deployment, and access needs.</p>
    </div>
  </div>
	<div class="heroInner">
