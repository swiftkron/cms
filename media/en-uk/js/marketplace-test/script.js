$(document).ready(function(){
	...
	$.ajax({
		type: "GET",
		url: "/media/en-uk/marketplace/featured-partners.xml",
		dataType: "xml",
		success: function(xml) {
			$(xml).find('partner').each(function(){
				...
				if($('.featured-grid ul li a').text().indexOf(name) == -1) {
					$('.featured-grid ul').append('<li><a href="/marketplace/business-list.html?partner='+variablename+'">'+name+'<br /><img src="/media/en-uk/marketplace/featured/logo-'+variablename+'.png" alt="'+name+'" /></a></li>');
				}
	...
	$.ajax({
		type: "GET",
		url: "/media/en-uk/marketplace/solutions.xml",
		dataType: "xml",
		success: function(xml) {
