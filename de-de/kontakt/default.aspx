...
<input type=hidden name="DialogID" value="80">
<input type="hidden" id="LeadSource" name="LeadSource" value="SPINTL Act German Contact Me">
<input type=hidden name="rurl" value="http://www.act.com/de-de/kontakt/?thankyou">
...
<div id="formElementX" class="formRow">
	<span id="reqOptIn">
		<input id="check1" type="checkbox" checked="check" onchange="setValues();" /> Ich bin damit einverstanden, dass ein Act! Mitarbeiter mich kontaktiert, damit ich bestm&ouml;gliche Unterst&uuml;tzung zur CRM Software und hilfreiche Informationen zu Act! erhalten kann. 
	</span>
</div>

<div id="formElement9"><input  class="btn btn-primary" type="submit" value="Abschicken" onClick="ga('send', 'event', 'DE Contact', 'send-message', 'send-message');"/></div>
