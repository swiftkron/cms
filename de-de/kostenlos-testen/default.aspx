...
<head>
        ...
        <link rel="alternate" hreflang="en-us" href="http://www.act.com/lp/trial/" />
...
<body id="trial_page">
            ...
            <div class="col-sm-6 contact-form tablecell">
              <div class="col-md-10 col-md-push-2">
                ...
                <form action="https://www.msgapp.com/RESTForm.aspx" method="GET">
                  ...
                  <input type="hidden" id="LeadSource" name="LeadSource" value="SPINTL ACT German trial form">
                  <input type=hidden name="rurl" value="http://www.act.com/de-de/kostenlos-testen/default.aspx?thankyou">
                  <input type=hidden name="DoNotSolicit" id="DoNotSolicit" value="0">
                  <input type=hidden name="TriggerID" id="TriggerID" value="1639">
                  ...
                  <div id="formElement4"  class="formRow">
                    <label for="WorkPhone">Telefon*</label>
                  ...
                  <div id="formElementX" class="formRow">
                    <span id="reqOptIn">
                      <input  id="check1" type="checkbox" checked="check" onchange="setValues();" />
                  ...
                  <input type="submit" class="btn btn-primary" value="Abschicken" onClick="ga('send', 'event', 'DE Demo', 'form-complete', 'trial-download');"/>
          ...
          function countryOptin(thisForm) {
            ...
            function setValues() {
              ...
              if (state == true) { 
                ...
                document.getElementById('TriggerID').value = "1639";
                document.getElementById('opIn').value = "Y"; }
              else if (state == false) { document.getElementById('DoNotSolicit').value = "1";
        ...
        <script>
          var thankYouMessage = '<h2 class="lead orangetitle">30 Tage Act! Pro gratis testen</h2><a class="btn btn-primary" href="http://cdn.act.dlm.swiftpage.com/3822/actpro_171x50_de.exe" onClick="ga("send", "event", "DE Demo", "pop-up", "download-now");"><strong class="buynow">Zum Download</strong></a><p><b>Bitte setzen Sie sich mit uns in Kontakt, sollten Sie Fragen haben oder nähere Informationen zu Act! benötigen.</b></p><p><b>Deutschland:</b> 069 643 508 433<br /><b>Schweiz:</b> 043 508 2364 <br /><b>Vertrieb Email:</b> <a href="mailto:vertrieb@swiftpage.com" onClick="ga("send", "event", "DE Demo", "pop-up", "vertrieb@swiftpage.com");">vertrieb@swiftpage.com</a></p><p><a href="produkte/Systemvoraussetzungen" target="_blank">Act! Systemvoraussetzungen</a></p><p><b>Wichtiger Hinweis:</b><br />Die Act! Testversion ist Version v16. Sollten Sie eine ältere Version von Act! bereits aktiv benutzen, bitte stellen Sie sicher, dass Sie die Act! Testversion und die Version von Act!, die Sie momentan benutzen, nicht auf demselben Rechner installieren.</p>';
